...
namespace OrderSystem
{
    ...
    public static class TestData
    {
        ...
        public static Dictionary<int, Order> Orders() => new Dictionary<int, Order>
        {
            ...
            { 127, new Order(55, 0, 0.0) },      // нулевое количество
            { 128, new Order(77, -1, 10.0) },    // отрицательное количество
        };
    ...
    public sealed class OrderService
    {
        ...
        /// <remarks>
        /// rollback = false и idempotent = false соответствуют текущей
        /// (исследуемой) версии системы: компенсирующая транзакция не
        /// реализована, повторная обработка заказа не блокируется.
        /// </remarks>
        ...
        {
            if (Idempotent && _processed.Contains(orderId))
